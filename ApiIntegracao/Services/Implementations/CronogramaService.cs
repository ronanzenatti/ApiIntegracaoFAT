    ...
    public class CronogramaService : ICronogramaService
    {
        ...
        public async Task<IEnumerable<CronogramaListaDto>> ListarCronogramasAsync(string? idTurmaFat = null, string? idDisciplinaFat = null)
        {
            ...
            return await query
                ...
                {
                    Id = t.Id,
                    IdTurmaFat = t.IdPortalFat != null ? t.IdPortalFat.ToString() : null,
                    NomeTurma = t.Nome,
                    IdDisciplinaFat = t.DisciplinaIdPortalFat != null ? t.DisciplinaIdPortalFat.ToString() : null,
                    NomeDisciplina = t.DisciplinaNomePortalFat,
                    IdCursoFat = t.Curso.IdPortalFat != null ? t.Curso.IdPortalFat.ToString() : null,
        ...
        public async Task<CronogramaDetalheDto?> ObterCronogramaAsync(string idTurmaFat, string idDisciplinaFat)
        {
            ...
            {
                Id = turma.Id,
                IdTurmaFat = turma.IdPortalFat != null ? turma.IdPortalFat.ToString() : null,
                NomeTurma = turma.Nome,
                IdTurmaCettpro = turma.IdCettpro,
                IdDisciplinaFat = turma.DisciplinaIdPortalFat != null ? turma.DisciplinaIdPortalFat.ToString() : null,
                NomeDisciplina = turma.DisciplinaNomePortalFat,
                IdCursoFat = turma.Curso.IdPortalFat != null ? turma.Curso.IdPortalFat.ToString() : null,
